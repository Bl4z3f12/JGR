...
<div class="col-lg-2 col-md-3 d-none d-md-block bg-dark text-white min-vh-100 p-0">
        ...
        <div class="offcanvas-body p-0">
            <div class="nav flex-column">
                ...
                <a href="diagramme.php" class="nav-link text-white py-3">
                    <i class="fas fa-chart-line me-2"></i> Production Status
                </a>
                <a href="barcode.php" class="nav-link text-white py-3">
                    <i class="fas fa-barcode me-2"></i> Barcode Management
                </a>
                <a href="reports.php" class="nav-link text-white py-3">
                    <i class="fas fa-file-alt me-2"></i> Reports
                </a>
                <a href="settings.php" class="nav-link text-white py-3">
